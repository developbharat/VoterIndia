...
interface IAuthAPI {
    // Sign up Screen
    @POST("/signup")
    suspend fun createAccount(@Field("name") name: String, @Field("mobile") mobile: String): CreateAccountDTO
    ...
    @POST("/authenticate")
    suspend fun validatePasscode(@Field("mobile") mobile: String, @Field("passcode") passcode: String): ValidatePasscodeDTO
